...
unsigned char config[] = // List of modified registers
{
  ...
  0x09, 0x03,           // ADDR     Device Address Address for this nodeBUS2
  ...
  0x17, 0x02,           // MCSM0    Main Radio Control State Machine Configuration
...
/* if(Serial.available())
  {*/
    ...
    data[1] = 0x01;           // Set Rx device address as 2
